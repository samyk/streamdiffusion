...
SEGMENTATION_BACKEND_LABELS = hal_control_defs.SEGMENTATION_BACKEND_LABELS
SEGMENTATION_BACKEND_NAMES = hal_control_defs.SEGMENTATION_BACKEND_NAMES
SCENE_IDLE_MODE_LABELS = hal_control_defs.SCENE_IDLE_MODE_LABELS
SCENE_IDLE_MODE_NAMES = hal_control_defs.SCENE_IDLE_MODE_NAMES
