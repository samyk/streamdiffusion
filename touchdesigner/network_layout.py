...
POSITIONS: dict[str, tuple[int, int]] = {
    ...
    # --- /project1/vidin ---
    "/project1/vidin/in1": (-800, 0),
    "/project1/vidin/scene_monitor": (-720, -120),
    "/project1/vidin/scene_thumb": (-600, -120),
    "/project1/vidin/scene_blur": (-550, -120),
    "/project1/vidin/scene_ref": (-500, -180),
    "/project1/vidin/scene_idle_tick": (-500, -260),
    "/project1/vidin/scene_diff": (-450, -120),
    "/project1/vidin/scene_mono": (-350, -120),
    "/project1/vidin/scene_topchop": (-300, -180),
    "/project1/vidin/scene_metric": (-250, -180),
    "/project1/vidin/scene_metric_lag": (-250, -220),
    "/project1/vidin/scene_seed": (-200, -220),
    "/project1/vidin/scene_seed_edge": (-100, -220),
